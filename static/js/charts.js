...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var metadataArray = data.metadata.filter(o => o.id == sample);
    ...
    var otuIds = ids.map(labels => `OTU ${labels}`).slice(0,10).reverse() 
    ...
    var barLayout = {
     title: {text: "Top 10 Bacteria Cultures Found", family: "Arial" , size: 30},
     labels:otuIds,
    ...
    var bubbleLayout = {
      title: {text:"Bacteria Cultures per Sample", font: "Arial", size: 18},
      xaxis: {title: 'OTU ID'},
      hovermode: "closest",
      plot_bgcolor: "darksalmon",
      paper_bgcolor: "darksalmon"
